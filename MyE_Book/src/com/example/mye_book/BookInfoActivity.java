...
public class BookInfoActivity extends Activity {
	...
	public class getBookInfoTask extends AsyncTask<String, String,String> {
		...
		protected void onPreExecute() {
			...
			pDialog.setMessage("正在与服务器通信，请稍后");
	...
	private void init() {
		...
		btn_collection.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (isCollect) {
					btn_collection.setText("点击收藏");
					//回传服务器，取消了收藏
					isCollect=false;
				}else{
					//Book字段collection_num+1
					//改变显示字符“取消收藏”
	...
	public TextView creat_txt_chapters(int index) {
		...
		Log.v(TAG, "创建了"+index+rd1.getText());
