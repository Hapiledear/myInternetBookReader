...
public class ReadActivity extends Activity {
	...
	public class GetChapter extends Thread{
		...
		public void run() {
			...
			Log.v(TAG, "下一章节信息:"+json.toString());
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    Log.v(TAG, "章节信息:"+chapter.toString());
	...
	private void init() {
		...
		observer.addOnPreDrawListener(new OnPreDrawListener() {
			...
			public boolean onPreDraw() {
				// TODO Auto-generated method stub
//				 Log.v(TAG,"使用ViewTreeObserver 获取宽高：width:"  
//                         + txt_show.getMeasuredWidth() + "---->height:"  
//                         + txt_show.getMeasuredHeight());  
				 h_context=txt_show.getMeasuredHeight();//文本总高度
				 h_ScrollView = mScrollView.getHeight();// 可视文本高度
...
//				h_context = txt_show.getMeasuredHeight();
				...
				break;
			case SCROL_PAGE:
			//	Log.v(TAG, "可视区:内容区=" + h_ScrollView + ":" + h_context);
